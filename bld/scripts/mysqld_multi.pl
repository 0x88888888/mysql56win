...
$opt_help          = 0;
$opt_log           = undef();
$opt_mysqladmin    = "D:/MySQL/bin/mysqladmin";
$opt_mysqld        = "D:/MySQL/bin/mysqld";
$opt_no_log        = 0;
$opt_password      = undef();
$opt_tcp_ip        = 0;
$opt_user          = "root";
...
#### order:  my_print_defaults mysqld datadir, D:/MySQL/share
####
...
sub init_log
{
  ...
  if (!defined($logdir))
  {
    $logdir= "D:/MySQL/share" if (-d "D:/MySQL/share" && -w "D:/MySQL/share");
  }
  if (!defined($logdir))
  {
      ...
      if ("--datadir=" eq substr($options[$j], 0, 10)) {
        ...
        if (! -d $datadir."/mysql") {
          if (-w $datadir) {
            ...
            $install_cmd="D:/MySQL/bin/mysql_install_db ";
...
#
#   Before using, you must create a my.cnf file either in D:/MySQL/my.cnf
...
[mysqld_multi]
mysqld     = D:/MySQL/bin/mysqld_safe
mysqladmin = D:/MySQL/bin/mysqladmin
user       = multi_admin
...
port       = 3307
pid-file   = D:/MySQL/MySQL Server 5.6/data2/hostname.pid2
datadir    = D:/MySQL/MySQL Server 5.6/data2
language   = D:/MySQL/share/mysql/english
user       = unix_user1
...
port       = 3308
pid-file   = D:/MySQL/MySQL Server 5.6/data3/hostname.pid3
datadir    = D:/MySQL/MySQL Server 5.6/data3
language   = D:/MySQL/share/mysql/swedish
user       = unix_user2

[mysqld4]
socket     = /tmp/mysql.sock4
port       = 3309
pid-file   = D:/MySQL/MySQL Server 5.6/data4/hostname.pid4
datadir    = D:/MySQL/MySQL Server 5.6/data4
language   = D:/MySQL/share/mysql/estonia
user       = unix_user3
 
[mysqld6]
socket     = /tmp/mysql.sock6
port       = 3311
pid-file   = D:/MySQL/MySQL Server 5.6/data6/hostname.pid6
datadir    = D:/MySQL/MySQL Server 5.6/data6
language   = D:/MySQL/share/mysql/japanese
user       = unix_user4
EOF
  exit(0);
}
