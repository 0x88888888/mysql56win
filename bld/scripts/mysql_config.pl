...
my $ldata   = 'D:/MySQL/MySQL Server 5.6/data';
my $execdir = 'D:/MySQL/bin';
my $bindir  = 'D:/MySQL/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('D:/MySQL/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('D:/MySQL/include', "include/mysql", "include");
...
$flags->{cflags}  = [@{$flags->{include}},split(" ",'/MD /Z7 /O2 /Ob1 /DNDEBUG /EHsc -DDBUG_OFF')];
$flags->{cxxflags}= [@{$flags->{include}},split(" ",'/MD /Z7 /O2 /Ob1 /DNDEBUG /EHsc -DDBUG_OFF')];
