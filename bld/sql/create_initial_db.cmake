...
SET(CMAKE_SOURCE_DIR "D:/mysql56win")
SET(CMAKE_CURRENT_BINARY_DIR "D:/mysql56win/bld/sql")
SET(MYSQLD_EXECUTABLE "D:/mysql56win/bld/sql/$(Configuration)/mysqld.exe")
...
EXECUTE_PROCESS(
  COMMAND "C:/Program Files/CMake/bin/cmake.exe" -E echo Executing ${BOOTSTRAP_COMMAND}
)
EXECUTE_PROCESS (
  COMMAND "C:/Program Files/CMake/bin/cmake.exe" -E
...
EXECUTE_PROCESS (  
  COMMAND "C:/Program Files/CMake/bin/cmake.exe" -E touch ${CMAKE_CURRENT_BINARY_DIR}/initdb.dep
)
