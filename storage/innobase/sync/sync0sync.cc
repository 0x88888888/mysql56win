...
/** Mutexes or rw-locks held by a thread 
    记录一个线程持有的所有mutex和rw_locks,
	在函数sync_thread_add_level中添加level信息
*/
struct sync_thread_t{
...
/** An acquired mutex or rw-lock and its level in the latching order 
    追踪持有该latch时的level信息，是sync_arr_t中的数组成员
*/
struct sync_level_t{
...
/******************************************************************//**
得到数组sync_thread_level_arrays中的一个sync_thread_t
...
/******************************************************************//**
从全局变量sync_thread_level_arrays中查找一个空闲的sync_thread_t的slot
...
/******************************************************************//**
查看当前线程的拥有所有的level是否含有传进来的level
	...
	ibool	relock)	/*!< in: TRUE if re-entering an x-lock */
{
	...
	/* 开始将latch，level添加到thread_slot->levels中去 */
