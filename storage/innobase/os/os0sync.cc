...
)
{
	...
	// sleep_condition_variable == SleepConditionVariableCS
...
#ifdef __WIN__
	// wake_all_condition_variable == WakeAllConditionVariable
...
/*==============*/
{
	...
	os_cond_module_init(); // 获得initialize_condition_variable等等的地址
