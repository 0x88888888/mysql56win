...
/*********************************************************************//**
判断事务对象的状态是否是TRX_STATE_NOT_STARTED
	...
	void	*p)	/*!< in: InnoDB handlerton */
{
	...
	if (!innobase_data_file_path) {
		innobase_data_file_path = (char*) "ibdata1:200M;ibdata2:500M;ibdata3:800M:autoextend";
...
innobase_change_buffering_inited_ok:
	...
	if (innobase_buffer_pool_instances == 0) {
		innobase_buffer_pool_instances = 8; // 默认buffer pool instance ==8
...
/*===============*/
	...
	uint		charset_number,	/*!< 字符集，in: number of the charset */
...
/******************************************************************//**
获取str中前prefix_len字节的字符数量(可能多字节)
