...
#ifdef UNIV_DEBUG
/****************************************************************//**
确认事务是否在trx_sys->ro_trx_list : &trx_sys->rw_trx_list中
...
/*****************************************************************//**
保存trx_sys->max_trx_id到FSP_TRX_SYS_PAGE_NO(5)的TRX_SYS_TRX_ID_STORE处
...
/*==========================*/
{
	...
	if (!srv_read_only_mode) {
		mtr_start(&mtr);
		/* 拿到FSP_TRX_SYS_PAGE_NO(5)对应的frame */
...
/*****************************************************************//**
创建TRX_SYS_PAGE_NO(5)对应的page,frame,block
...
Tags the system table space with minimum format id 
