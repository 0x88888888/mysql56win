...
/****************************************************************//**
创建trx_t对象，默认TRX_ISO_REPEATABLE_READ级别
...
/****************************************************************//**
将trx按照trx->id的从大到小的次序插入到trx_sys->rw_trx_list中去
...
/****************************************************************//**
在mysql.innodb启动的时候调用这个函数，初始化trx_sys系统
