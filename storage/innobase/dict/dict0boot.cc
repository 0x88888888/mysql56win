	...
	mtr_t*	mtr)	/*!< in: mtr */
{
	...
	/* 
	   Create the dictionary header file block in a new, 
       allocated file segment in the system tablespace 
	*/
...
/*****************************************************************//**
系统首次启动的时候，创建系统表SYS_TABLES,SYS_COLUMNS,SYS_INDEX,SYS_FIELDS
