...
/*======================*/
	...
	enum hash_table_sync_t	type,	/*!< in: 
	                 用mutex或则rw_lock控制访问hash table的cells(buckets)
...
/*******************************************************************//**
hash cells(buckets)中的元素一般来讲，是链表形式的
Gets the next struct in a hash chain, NULL if none. */

#define HASH_GET_NEXT(NAME, DATA)	((DATA)->NAME)

/********************************************************************//**
查找 TABLE.array[fold]->node == DATA
...
/********************************************************************//**
在整个hash表中查找，不经过hash值计算，而是遍历TABLE->array,然后逐个链表遍历
...
# endif /* !UNIV_HOTBACKUP */
	...
	ulint			n_cells;/* number of cells(buckets) in the hash table */
	// hash桶数组， hash_cell_t == void* node 
