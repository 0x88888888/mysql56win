...
/** 
Maximum record size which can be stored on a page, 
without using the special big record storage structure 
16K/2 - 200
*/
#define	BTR_PAGE_MAX_REC_SIZE	(UNIV_PAGE_SIZE / 2 - 200)

/** @brief Maximum depth of a B-tree in InnoDB.
不是btree的真正深度，是平常的比如查找操作的控制深度
...
/*
btr_cur_search_to_nth_level中的 latch_mode的一部分可以用的flag
*/
...
/*
对于非叶子节点的插入都是悲观插入。非叶子节点的插入有函数btr_insert_on_non_leaf_level完成
*/
