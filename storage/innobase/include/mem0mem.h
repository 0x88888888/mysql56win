...
DYNAMIC means allocation from the dynamic memory pool of the C compiler, 
BUFFER means allocation from the buffer pool; 
the latter method is used for very big heaps */
...
struct mem_block_info_t {
	...
	/* 
	系统中mem_block_t链表的起始节点，只在第一个mem_block_t对象中定义
	其余的mem_block_t对象不定义
	*/
	UT_LIST_BASE_NODE_T(mem_block_t) base; /* In the first block in the
			the list this is the base node of the list of blocks;
			in subsequent blocks this is undefined */
	//整个系统中 mem_block_t对象构成一个链表
	...
	//当前mem_block_t管理的内存的空闲空间起始地址
	ulint	free;	/*!< offset in bytes of the first free position for
			user data in the block */
	//当前mem_block_t管理的内存的起始地址
