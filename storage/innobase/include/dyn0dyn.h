...
struct dyn_block_t{
	...
	ulint		used;	/*!< number of data bytes used in this block;
				...
				becomes full */
	byte		data[DYN_ARRAY_DATA_SIZE]; //DYN_ARRAY_DATA_SIZE == 512
				/*!< storage for array elements */
	UT_LIST_BASE_NODE_T(dyn_block_t) base; //系统管理dyn_block_t数组的链表
				/*!< linear list of dyn blocks: this node is
				used only in the first block */
	UT_LIST_NODE_T(dyn_block_t) list;//dyn_block_t 内部链表
