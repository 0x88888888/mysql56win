...
/* States of an undo log segment 
   undo page中的undo log segment header的 TRX_UNDO_STATE的取值
*/
...
/** 38 The offset of the undo log page header on pages of the undo log */
...
有XA Transaction时的undo log header加上去之后的格式
*/
/* @{ */
/** xid_t::formatID */
