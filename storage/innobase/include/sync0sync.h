...
#define SYNC_IBUF_HEADER	914  /* 表示持有insert buffer段头页的 latch*/
#define SYNC_IBUF_PESS_INSERT_MUTEX 912  /* 保证 insert buffer header中的free list的并发安全的，一个现场插入，一个线程删除 */
/*-------------------------------*/
...
#define SYNC_IBUF_MUTEX		370	/* ibuf_mutex，用于保护ibuf对象 */
/*------------------------------------- Change buffer tree */
#define SYNC_IBUF_INDEX_TREE	360
#define SYNC_IBUF_TREE_NODE_NEW	359
#define SYNC_IBUF_TREE_NODE	358
#define	SYNC_IBUF_BITMAP_MUTEX	351   /* 用于保护bitmap页并发控制 */
