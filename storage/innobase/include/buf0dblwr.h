...
The header of the doublewrite buffer is placed on the 
trx system header page. */
UNIV_INTERN
void
...
struct buf_dblwr_t{
	ib_mutex_t	mutex;	/*!< mutex protecting the first_free
				field and write_buf */
	ulint		block1;	/*!< Ò³ºÅ,the page number of the first
				doublewrite block (64 pages) */
	ulint		block2;	/*!< Ò³ºÅ,page number of the second block */
