...
/** 
从os_mem_alloc_large和malloc处分配的内存总和
...
//UNIV_HOTBACKUP 没有定义
	...
	if (UNIV_LIKELY(srv_use_sys_malloc)) {
		/*
		  在srv_use_sys_malloc 被设置的情况下，分配的内存数量不被计入ut_total_allocated_memory
		*/
		ret = malloc(n);
