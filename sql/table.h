...
/**
 Object_creation_ctx -- interface for creation context of database objects
                        (views, stored routines, events, triggers). 
 Creation context -- is a set of attributes, 
                     that should be fixed at the creation time and then be used
...
struct TABLE_SHARE
{
  ...
  */
  ...
  //有几个TABLE对象引用到这个 TABLE_SHARE instance
...
public:
  ...
  */
  ...
  /*
   ...
   A non-zero query_id is used to control which tables
