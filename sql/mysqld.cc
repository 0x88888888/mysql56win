...
#endif
{
  ...
  */
  ...
  my_defaults_read_login_file= FALSE;
                     //my              //mysqld,server,mysqld-5.6
  //这一步，把配置文件中的参数转到 argv中去
  ...
  */
...

  {
	...
	/*
	  ...
	  open_files_limit，
      max_connections
      table_cache_size，table_cache_size_per_instance
      table_def_size
	*/
...
int handle_early_options()
{
  ...
  //把all_sys_vars灌到all_early_options中来
  sys_var_add_options(&all_early_options, sys_var::PARSE_EARLY);

  /* Add the command line options parsed early */
  //my_long_early_options 灌到all_early_options
