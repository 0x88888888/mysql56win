...
enum enum_mdl_type {
  /*
	...
	1. 共享锁
	2. 意向锁，锁住一个范围
	3. 任何语句都会获取MDL意向锁，然后再获取更强级别的MDL锁。
  */
  ...
  */
  ...
  /*
	...
	1. 共享锁
	2. 共享锁，表示只访问表结构
	3. show create table 等, 只访问INFORMATION_SCHEMA的语句
  */
  ...
  */
  ...
  /*
	...
	1. 共享锁
	2. 可升级锁，访问表结构并且读写表数据，并且禁止其它事务读写。
	3. LOCK TABLES ... WRITE
  ...
  */
  ...
  /*
	...
	1. 写锁
	2. 禁止其它事务读写。
    3. CREATE/DROP/RENAME TABLE等DDL语句。
...
public:
  ...
  */
  enum enum_mdl_namespace { GLOBAL=0, //全局，范围
                            SCHEMA,   //库锁,对象
                            TABLE,    //表锁, 对象
                            FUNCTION, //函数锁,对象
                            PROCEDURE, //存储过程锁, 对象
