...
/*
before_wait = scheduler_wait_lock_begin,
 after_wait = scheduler_wait_lock_end
*/
...
static void wake_up_waiters(THR_LOCK *lock)
{
  ...
  {//没有正在write的lock了
    data=lock->write_wait.data;//等待write的wait 
